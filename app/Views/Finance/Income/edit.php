            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="datetime-local" id="date" name="date" class="form-control form-control-border form-control-sm" value="<?= dateTimeJS($income->date) ?>">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input id="amount" name="amount" class="form-control form-control-border form-control-sm currency" value="<?= $income->amount ?>">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
...
<script>
  ...
  $(document).ready(function() {
    ...
    initModalForm({
      form: '#form',
      submit: '#submit',
      url: base_url + '/finance/income/edit/<?= $income->id ?>'
    });
  });
</script>